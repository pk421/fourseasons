...
def convert_to_dict(result):
    header_names = ('symbol', 'latest_name', 'latest_date', 'latest_time', 'latest_price', 'volume', 'sigma_over_p_0', 'rsi_0', 'sma_0', 'sigma_0', 'stop_loss_offset', 'volatility_percentile')
...
#		pass
    ...
    volatility_0 = round(volatility[-1])
    ...
    ret_values =  (symbol, latest_name, latest_date, latest_time, sigma_over_p_0, latest_price, volume, rsi_0, sma_0, sigma_0, stop_loss_offset, volatility_percentile)
